...
function Support() {
  ...
  return (
    <div className='flex flex-col justify-start items-center w-[100%] h-[100%]' style={{ background: "#101010" }}>
        ...
        <p className="mt-[11px] text-[17px] font-syne text-white font-semibold ">Contact Support</p>
        ...
        <p className='font-sans font-semibold text-[15px] text-white mt-[24px] w-[90%] text-left' style={{ opacity: ".6" }}>Your comment or question</p>
