...
function FullMetric() {
  ...
  return (
    <div className='flex flex-col justify-start items-center w-[100%] relative' >
        ...
        <p className="mt-[11px] text-[17px] font-syne text-white font-semibold ">{title}</p>
        <p className="mt-[14px] text-[15px] font-syne text-white font-medium ml-[17px]" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>Сравнение вашей техники бега со стандартной</p>
          {isModalOpen && (
      ...
      {
        videoUrl &&
          <img src="/icons/playVideo.svg" className='absolute top-[140px] z-20' style={{ pointerEvents: "none" }} alt="" />
      }
          {videoUrl ? (
            <video
            src={videoUrl}
    ...
    <div className="w-[90%] mt-5 h-[198px] bg-white rounded-lg flex flex-col justify-center items-center">
      ...
      <p className='w-[311px] font-sans font-medium opacity-70 mt-1' style={{ lineHeight: "120%" }}>
      Бегун набрал {percent}% по показателю близости удара ногой к центру тяжести, продемонстрировав отличную технику и самоотдачу на тренировках.
      </p>
      ...
      <Button onClick={() => navigate('/results')} className="mt-5">Получить упражнения</Button>
    </div>
  )
}
