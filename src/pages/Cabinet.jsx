          ...
          <div className="w-[90%] min-h-[454px] bg-white rounded-[8px] flex flex-col justify-start items-center relative">
              ...
              {selectedFile ? (
                <div className="flex flex-col items-center">
                  ...
                  <input
                    ...
                    className="mt-2 w-[80%]"
                  />
                  <Button onClick={handleSaveAvatar} className="mt-2 w-[250px]">
                    Сохранить
                  </Button>
                </div>
              ) : (
            ...
            <div className="flex justify-center items-center gap-4 h-[15px] mt-4">
              <input
                ...
                className="border-none outline-none w-[300px] text-center"
                onBlur={saveName}
              ></input>
            ...
            <div className="mt-2 flex justify-center items-start gap-[13px]">
              <img
                onClick={() => (window.location.href = "https://t.me/JogJoy")}
                src="/icons/tg.svg"
                alt=""
              />
              <img
                onClick={() => (window.location.href = "https://jogjoy.run")}
                src="/icons/sait.svg"
                alt=""
              />
              ...
              <img
                onClick={() =>
                  (window.location.href =
                    "https://www.instagram.com/jogjoy_official")
                }
              ...
              <img
                onClick={() => {
                  window.location.href =
                    "https://www.youtube.com/@JogJoy-running";
                }}
                src="/icons/геги.svg"
                alt=""
              />
