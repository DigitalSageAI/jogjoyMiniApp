...
function VideoPage() {
  ...
  return (
    <div className='flex flex-col justify-start items-center w-[100%]'>
        ...
        <p className='w-[90%] text-left font-sans text-[15px] text-white mt-[19px]'>Как правильно снять видео</p>
        ...
        <div className='mt-2 gap-1 flex justify-start items-start w-[90%]' style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
            <span>2.</span>
            <p>В 7 метрах от бегуна (видны голова и пальцы ног)</p>
        </div>
        <div className='mt-2 gap-1 flex justify-start items-start w-[90%]' style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
            <span>3.</span>
            <p>Бегун должен пробежать не менее 50 метров, прежде чем оказаться перед камерой</p>
        </div>
        <div className='mt-2 gap-1 flex justify-start items-start w-[90%]' style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
            <span>4.</span>
            <p>Продолжительность видео должна составлять не более 10 секунд</p>
        </div>
